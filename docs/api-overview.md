...
| `sparkoperator` _[DSCSparkOperator](#dscsparkoperator)_ | Spark Operator component configuration. |  |  |
...
| `sparkoperator` _[DSCSparkOperatorStatus](#dscsparkoperatorstatus)_ | Spark Operator component status. |  |  |
